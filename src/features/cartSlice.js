...
export const { addCartItem, removeCartItem, clearCartItem, decreaseQuantity, increaseQuantity, calculateTotalAmount, storeInLocalStorage, getFromLocalStorage } = cartSlice.actions
